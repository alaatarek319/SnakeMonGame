...
{
	pWind->FlushMouseQueue();// Note: x and y of WaitMouseClick are sent by reference
...
ActionType Input::GetUserAction() const
{
	...
	if (UI.InterfaceMode == MODE_DESIGN)
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_COPYCARD:return COPYCARD;
			case ITM_CUTCARD:return CUTCARD;
			case ITM_PASTECARD:return PASTECARD;
