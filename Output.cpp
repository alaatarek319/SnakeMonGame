...
int Output::GetCellStartY(const CellPosition & cellPos) const
{
	...
	return (55 + cellPos.VCell() * UI.CellHeight); // this line should be changed with your implementation
}
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_CUTCARD] = "images\\cut.jpg";
	MenuItemImages[ITM_COPYCARD] = "images\\copy.jpg";
	MenuItemImages[ITM_PASTECARD] = "images\\paste.jpg";
	MenuItemImages[ITM_EDITCARD] = "images\\edit.jpg";
	MenuItemImages[ITM_DELETE_GAME_OBJECT] = "images\\delete.jpg";
	MenuItemImages[ITM_SAVE_GRID] = "images\\save.jpg";
	MenuItemImages[ITM_SWITCH_TO_PLAY_MODE] = "images\\switch.jpg";
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_SWITCH_TO_DESIGN_MODE] = "images\\switch.jpg";
	MenuItemImages[ITM_ROLL_DICE] = "images\\rolldice.jpg";
	MenuItemImages[ITM_INPUT_DICE_VALUE] = "images\\inputvalue.jpg";
	MenuItemImages[ITM_NEW_GAME] = "images\\newgame.jpg" ;
	MenuItemImages[ITM_EXIT_PLAYMODE] = "images\\exit.jpg";
...
void Output::PrintPlayersInfo(string info)
{
	...
	pWind->SetPen(UI.ToolBarColor, 1);
	pWind->SetBrush(UI.ToolBarColor);
	pWind->DrawRectangle(UI.width/2.0, 0, UI.width, UI.ToolBarHeight);
...
void Output::DrawSnake(const CellPosition & fromCell, const CellPosition & toCell) const
{
	...
	int ix[4] = { x12,x12+ xChange,x12,x12 - xChange };
	int iy[4] = {y1+yChange,y1,y1-yChange,y1 };
