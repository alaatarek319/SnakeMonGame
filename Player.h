...
public:
	...
	int  GetPlayerNumber() const;               // A getter for the player number
	int  GetTurnCount() const;		            // A getter for the turnCount
	int  GetRollDice()const;                    // A getter for the rolled dice number
	int  GetStepCount()const;                   // A getter for the stepCount
	void setTurnCount(int t);                   // A setter for the turnCount
	void SetStepCount(int s);                   // A setter for the stepCount
	void SetJustRolledDiceNum(int DiceNum);     // A setter for the  rolled dice numbere
	void SetStop(bool S);                       // A setter for the  Stop flag
